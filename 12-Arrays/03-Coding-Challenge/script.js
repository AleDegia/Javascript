...
const checkDogs = function(dogsJulia, dogsKate){
  onlyDogsJulia =  dogsJulia.splice(1,2);
  console.log(onlyDogsJulia);//[5, 2]
}
checkDogs(dogsJulia, dogsKate);

const JuliaAndKateData =  [...onlyDogsJulia, ...dogsKate];
console.log(JuliaAndKateData);  //[5, 2, 10, 5, 6, 1, 4]

//4)
JuliaAndKateData.forEach(function(dog, i){
    if (dog >= 3) {
